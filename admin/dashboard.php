...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>OLMS | Admin Dash Board</title>
...
?>
                        ...
                        <a href="book.php" class="small-box-footer" style="    position: relative;
    text-align: center;
    padding: 3px 0;
    color: #fff;
    ...
    text-decoration: none;">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
